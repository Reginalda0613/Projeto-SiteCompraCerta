...
<h2 class="text-center">
    Cadastro de Pedido <i class="fa fa-list"></i>
</h2><br>
    ...
    <div class="container">
        <div class="form-row">
            ...
            <div class="col-md-4">
                ...
                <input class="form-control" type="data" name="birth" required values="<?=$cliente['data']?>"><br>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-8 text-right">
                <a href="compra.php"><button type="button" class="btn btn-primary">
                   Finalizar Pedido  <i class="fa fa-user-edit"></i>
                </button></a>
        </div>
    </div>
</form>
